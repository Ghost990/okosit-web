...
export default function CTA() {
  ...
  return (
    <section 
      className="py-20 bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 dark:from-primary-700 dark:via-primary-800 dark:to-primary-900 relative overflow-hidden"
    >
      {/* Background Pattern */}
      <motion.div 
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 
            className="heading-1 text-white dark:text-white mb-6"
          >
            {t.common.cta.title}
            <span 
              className="block"
          ...
          <p 
            className="text-xl text-primary-100 dark:text-primary-200 max-w-3xl mx-auto mb-8"
          >
        ...
        >
          ...
          <div className="space-y-8">
            <div 
              className="bg-white/10 dark:bg-white/5 backdrop-blur-sm rounded-2xl p-8"
            >
              <h3 
                className="heading-3 text-white dark:text-white mb-6"
              >
              ...
              >
                {t.common.cta.benefits.map((benefit, index) => (
                  ...
                  >
                    <div 
                      className="w-2 h-2 bg-primary-300 dark:bg-primary-500 rounded-full"
                    />
            ...
            >
              ...
              <div 
                className="bg-white/10 dark:bg-white/5 backdrop-blur-sm rounded-xl p-6 text-center"
              >
                <div>
          ...
          >
            <h3 
              className="heading-3 text-secondary-900 dark:text-white mb-6"
            >
